...
for args.nu in [0.105, 0.205, 0.305, 0.405, 0.505, 0.605, 0.705, 0.805, 0.905]:
    # 创建目录
    ...
    np.savez(os.path.join(base_dir, f"nu={args.nu}_u_pre.npz"), t=t_star, x=x_star, u_pre=u_pred_picture)
    print(l2_error)
    # predict solution
    plt.figure(figsize=(5, 4), dpi=150)
